...
export const metadata = {
  title: "Complex Search Made Easy — Khrystyna Arnoldy",
  description:
    "Redesigning a legacy query builder with AI assistance to make complex data searches accessible to everyone.",
};
      ...
      <main>
        ...
        <section className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            <h1 className={styles.heroTitle}>Complex Search Made Easy</h1>
        ...
        <section className={styles.section}>
          <div className={styles.container}>
            ...
            {/* Label + pull quote — 20px gap between them */}
            ...
            <div className={styles.narrative}>
              ...
              <div className={styles.narrativeBlock}>
                <div className={styles.narrativeAnnotation}>
                  <h3 className={styles.narrativeSubheading}>Search habits</h3>
          ...
          <div className={styles.container}>
            ...
            <div className={styles.goalGrid}>
              <div className={styles.goalCard}>
                <h3 className={styles.goalHeading}>Intuitive design</h3>
              ...
              <div className={styles.goalCard}>
                <h3 className={styles.goalHeading}>Efficient tool</h3>
                <p className={styles.goalBody}>
        ...
        <section className={styles.section}>
          <div className={styles.container}>
            ...
            <div className={styles.demoBlock}>
              <p className={`${styles.label} ${styles.labelDemo}`}>Quick Demo</p>
